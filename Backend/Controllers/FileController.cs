...
public class FileController : ControllerBase
{
    ...
    /// </summary>
    /// <param name="files">The file to upload (supports PNG, JPEG, MP4, AVI, GIF)</param>
    ...
    public async Task<ActionResult<Response>> Upload(IFormFile file)
    {
        try
        {
            ...
            return Ok(new Response(true, $"Files uploaded successfully. File names: {uniqueFileName}", uniqueFileName));
        }
        catch (Exception ex)
        {
